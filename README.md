...
[![Go Report Card](https://goreportcard.com/badge/github.com/Marreck/go-algorand-sdk)](https://goreportcard.com/report/github.com/Marreck/go-algorand-sdk/v2)
[![GoDoc](https://godoc.org/github.com/Marreck/go-algorand-sdk?status.svg)](https://godoc.org/github.com/Marreck/go-algorand-sdk/v2)
...
Full documentation is available [on pkg.go.dev](https://pkg.go.dev/github.com/Marreck/go-algorand-sdk/v2). You can also self-host the documentation by running `godoc -http=:8099` and visiting `http://localhost:8099/pkg/github.com/Marreck/go-algorand-sdk/v2` in your web browser.
...
```sh
go get -u github.com/Marreck/go-algorand-sdk/...
```
